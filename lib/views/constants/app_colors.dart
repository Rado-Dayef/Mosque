...
class AppColors{
  static Color dark = isDarkTheme == true ? const Color(0xFFB0B3B8) : const Color(0xFF3b5998);
  static Color light = isDarkTheme == true ? const Color(0xFF242526) : const Color(0xFFFFFFFF);
