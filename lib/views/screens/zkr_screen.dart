...
import 'package:com.rado.mosque/views/constants/app_language_translator.dart';
...
import 'package:com.rado.mosque/controllers/zkr_controller.dart';
            ...
            child: Column(
              children: [
                ...
                Center(
                  child: Obx(
                    () {
                      final azkarSectionDetails = zkrController.azkarSectionDetails;
                          ...
                          return Column(
                            children: [
                              GestureDetector(
                                ...
                                onLongPress: () {
                                  if (counter.value >= 0 && counter.value < count.value) {
                                    counter.value++;
                                  }
                                },
                                child: Padding(
                                      ...
                                      children: [
                                        ...
                                        Obx(
                                          () => CircularPercentIndicator(
                                            ...
                                            percent: (counter.value / count.value).toDouble(),
                                            progressColor: AppColors.dark,
                                            backgroundColor: AppColors.light,
                                            circularStrokeCap: CircularStrokeCap.round,
                                            center: Text(
                                              "${counter.value}".languageTranslator,
                                              style: TextStyle(
                                                color: AppColors.dark,
                                                fontSize: 24.sp,
                                              ),
