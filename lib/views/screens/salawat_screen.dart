import 'package:com.rado.mosque/views/widgets/build_salawat_time_list_item.dart';
...
import 'package:com.rado.mosque/controllers/salawat_controller.dart';
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  normalFormat.format(nextPrayerTime).replaceAll(RegExp(r"[APM]"), AppConstants.emptyText),
                                  style: TextStyle(
                                    color: AppColors.light,
                                    fontSize: 28.sp,
                                ...
                                Text(
                                  normalFormat.format(nextPrayerTime).contains(AppConstants.amLargeFormat) ? AppConstants.amSmallFormat : AppConstants.pmSmallFormat,
                                  style: TextStyle(
                                    color: AppColors.light,
                                    fontSize: 18.sp,
