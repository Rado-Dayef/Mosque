...
import 'package:com.rado.mosque/models/zkr_model.dart';
...
class ZkrController extends GetxController {
  ...
  Future<void> loadSectionDetail() async {
    try {
      final data = await DefaultAssetBundle.of(Get.context!).loadString(AppConstants.azkarSectionDetailsJson);
