...
import 'package:com.rado.mosque/controllers/main_controller.dart';
import 'package:com.rado.mosque/views/constants/app_colors.dart';
import 'package:com.rado.mosque/views/constants/app_pages.dart';
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  return GetMaterialApp(
                    ...
                    theme: snapshot.data ?? true ? ThemeData(
